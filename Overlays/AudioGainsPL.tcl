...
################################################################
# This is a generated script based on design: AudioOnly
#
...
User_Company:SysGen:audioprocessing:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set audio_clk_10MHz [ create_bd_port -dir O -from 0 -to 0 -type clk audio_clk_10MHz ]
  ...
  # Create instance: audioprocessing_0, and set properties
  set audioprocessing_0 [ create_bd_cell -type ip -vlnv User_Company:SysGen:audioprocessing:1.0 audioprocessing_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {3.125} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {unassigned#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#unassigned#Quad SPI Flash#unassigned#unassigned#unassigned#unassigned#unassigned#UART 0#UART 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#SD 0#unassigned#unassigned#I2C 0#I2C 0#Enet 0#Enet 0} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins audio_codec_ctrl_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins audioprocessing_0/audioprocessing_s_axi] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net audio_codec_ctrl_0_bclk [get_bd_pins audio_codec_ctrl_0/bclk] [get_bd_pins audioprocessing_0/bclk_in]
  connect_bd_net -net audio_codec_ctrl_0_codec_address [get_bd_ports codec_addr] [get_bd_pins audio_codec_ctrl_0/codec_address]
  connect_bd_net -net audio_codec_ctrl_0_lrclk [get_bd_pins audio_codec_ctrl_0/lrclk] [get_bd_pins audioprocessing_0/lrclk_in]
  connect_bd_net -net audioprocessing_0_bclk_out [get_bd_ports bclk] [get_bd_pins audioprocessing_0/bclk_out]
  connect_bd_net -net audioprocessing_0_lrclk_out [get_bd_ports lrclk] [get_bd_pins audioprocessing_0/lrclk_out]
  connect_bd_net -net audioprocessing_0_serial_out [get_bd_ports sdata_o] [get_bd_pins audio_codec_ctrl_0/sdata_i] [get_bd_pins audioprocessing_0/sdata_out]
  connect_bd_net -net clk_wiz_10MHz_clk_out1 [get_bd_ports audio_clk_10MHz] [get_bd_pins clk_wiz_10MHz/clk_out1]
  connect_bd_net -net ps7_0_FCLK_CLK0 [get_bd_pins audio_codec_ctrl_0/s_axi_aclk] [get_bd_pins audioprocessing_0/clk] [get_bd_pins clk_wiz_10MHz/clk_in1] [get_bd_pins ps7_0/FCLK_CLK0] [get_bd_pins ps7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_fclk0/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins audio_codec_ctrl_0/s_axi_aresetn] [get_bd_pins audioprocessing_0/audioprocessing_aresetn] [get_bd_pins clk_wiz_10MHz/resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn]
  connect_bd_net -net sdata_i_1 [get_bd_ports sdata_i] [get_bd_pins audioprocessing_0/sdata_in]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs audioprocessing_0/audioprocessing_s_axi/reg0] SEG_audioprocessing_0_reg0
